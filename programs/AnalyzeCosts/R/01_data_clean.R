...
#' Process purchasing and sales data
#'
#' This function is the first step in the data cleaning process
#' @param pur the path of the purchase history data (one dataset only, xlsx format) as a string
#' @param sal the path of the sales history data (one dataset only, xlsx format) as a string
#' @keywords purchase sales history
#' @export
#' @examples
#' process_purchase_sales_data(pur = "C:/Users/Documents/Data/Purchase History/Pur_History_2014-2018.xlsx",
#'                             sal = "C:/Users/Documents/Data/Sales History/Sales Data 2014-2018.xlsx")
#' 
process_purchase_sales_data <- function(pur, sal){
  ##### Read files
  
  path_dir <- "./data/redtomato"
  output_dir <- "./data/redtomato/output"
  
  pur <- read.xlsx(pur, startRow = 4)
  sal <- read.xlsx(sal, startRow = 5)
