...
#'
#' This function allows you to process terminal data
#' @param path of the data, as a string. Needs to point to a xlsx file (only one)
#' @keywords terminal processing
#' @export
#' @examples
#' process_terminal("C:/Users/Documents/Data/terminal_2018.xlsx)

process_terminal <- function(path){
  # input library
