...
* Sales history: includes aggregate data on Red Tomato profits by every type of each species of produce 
* Final cleaned data: Apple species, ECOApple status, ECOApple visibility, Customer cost of farmer, Customer cost to logistics, Customer to RT, Total customer price
